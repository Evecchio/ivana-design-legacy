{% set section_shell_class = 'ivana-home-slot ivana-home-slot-' ~ section_select %}

{% if section_select == 'slider' %}

    {#  **** Home slider ****  #}
    <section class="{{ section_shell_class }}" data-store="home-slider">
...
{% elseif section_select == 'categories' %}
    ...
    <section class="js-section-banner-home section-home section-banners-home position-relative overflow-none {{ section_without_margins }} {{ section_shell_class }}" data-store="home-banner-categories">
...
{% elseif section_select == 'promotional' %}
    ...
    <section class="js-section-banner-home section-home section-banners-home position-relative overflow-none {{ section_without_margins }} {{ section_shell_class }}" data-store="home-banner-promotional">
...
{% elseif section_select == 'news_banners' %}
    ...
    <section class="js-section-banner-home section-home section-banners-home position-relative overflow-none {{ section_without_margins }} {{ section_shell_class }}" data-store="home-banner-news">
...
{% elseif section_select == 'modules' %}
    ...
    {#  **** Modules ****  #}
    <section class="section-home section-banners-home position-relative py-4 {{ section_shell_class }}" data-store="home-image-text-module">
...
{% elseif section_select == 'institutional' %}
    ...
    <section class="{{ section_shell_class }}" data-store="home-institutional-message">
...
{% elseif section_select == 'main_categories' %}
    ...
    {#  **** Main categories ****  #}
    <section class="{{ section_shell_class }}" data-store="home-categories-featured">
...
{% elseif section_select == 'timer_offers' %}
    ...
    {#  **** Timer offers ****  #}
    <section class="section-timer-offers {{ section_shell_class }}" data-store="home-timer-offers">
...
{% elseif section_select == 'video' %}
    ...
    {#  **** Video embed ****  #}
    <section class="section-video-home {{ section_shell_class }}" data-store="home-video">
...
{% elseif section_select == 'brands' %}
    ...
    {#  **** Brands ****  #}
    <section class="section-brands-home {{ section_shell_class }}" data-store="home-brands">
...
{% elseif section_select == 'testimonials' %}
    ...
    {#  **** Testimonials ****  #}
    <section class="section-testimonials-home {{ section_shell_class }}" data-store="home-testimonials">
...
{% elseif section_select == 'newsletter' %}
    ...
    {#  **** Newsletter ****  #}
    <section class="{{ section_shell_class }}" data-store="home-newsletter-shell">
...
{% elseif section_select == 'instafeed' %}
    ...
    {#  **** Instafeed ****  #}
    <section class="{{ section_shell_class }}" data-store="home-instafeed-shell">
...
{% elseif section_select == 'products' %}
    ...
    {#  **** Featured products ****  #}
    <section class="{{ section_shell_class }}" data-store="home-products-featured-shell">
...
{% elseif section_select == 'new' %}
    ...
    {#  **** New products ****  #}
    <section class="{{ section_shell_class }}" data-store="home-products-new-shell">
        {% if show_help or (show_component_help and not has_products) %}
...
{% elseif section_select == 'sale' %}
    ...
    {#  **** Sale products ****  #}
    <section class="{{ section_shell_class }}" data-store="home-products-sale-shell">
        {% if show_help or (show_component_help and not has_products) %}
...
{% elseif section_select == 'main_product' %}
    ...
    {#  **** Main product ****  #}
    <section class="{{ section_shell_class }}" data-store="home-main-product-shell">
        {% if show_help or (show_component_help and not has_products) %}
...
{% elseif section_select == 'informatives' %}
    ...
    <section class="js-section-informative-banners {{ informative_banners_color }} {{ section_shell_class }}" data-store="banner-services">
