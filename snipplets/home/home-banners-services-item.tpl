	...
	{% else %}
		<div class="js-informative-banner-icon-{{ banner_index }} premium-banner-icon">
			...
			{% elseif banner_services_icon == 'card' %}
				<svg class="icon-inline svg-icon-text"><use xlink:href="#credit-card"/></svg>
			{% elseif banner_services_icon == 'security' %}
				<svg class="icon-inline svg-icon-text"><use xlink:href="#security"/></svg>
			{% elseif banner_services_icon == 'returns' %}
				<svg class="icon-inline svg-icon-text"><use xlink:href="#returns"/></svg>
			{% elseif banner_services_icon == 'whatsapp' %}
				<svg class="icon-inline svg-icon-text"><use xlink:href="#whatsapp-line"/></svg>
			{% elseif banner_services_icon == 'promotions' %}
				<svg class="icon-inline svg-icon-text"><use xlink:href="#promotions"/></svg>
			{% elseif banner_services_icon == 'cash' %}
				<svg class="icon-inline svg-icon-text"><use xlink:href="#cash"/></svg>
			{% endif %}
		</div>
	{% endif %}
