...
<section class="section-newsletter-home py-4" data-store="home-newsletter">
	<div class="js-home-newsletter {% if not settings.news_full %} container{% endif %}">
		<div class="js-home-newsletter-container home-background-container ivana-home-newsletter-panel{% if not (newsletter_image or newsletter_mobile_image) %} home-background-container-center{% endif %} {% if settings.home_news_colors %}section-newsletter-home-colors{% endif %}">
