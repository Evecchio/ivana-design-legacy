<div class="pt-md-3 ivana-product-form">
	...
	{% endif %}
		...
		<div class="js-product-discount-container mb-2 font-medium" {% if hideDiscountContainer %}style="display: none;"{% endif %}>
			<span class="text-accent ivana-product-transfer-plus">+</span> <span class="text-accent">{{ product.maxPaymentDiscount.value }}% {{'de descuento' | translate }}</span> {{'pagando con' | translate }} {{ product.maxPaymentDiscount.paymentProviderName }}
